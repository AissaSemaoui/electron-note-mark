...
export const NodeSelector = ({ open, onOpenChange }: NodeSelectorProps) => {
  ...
  return (
    <Popover modal={true} open={open} onOpenChange={onOpenChange}>
      <PopoverTrigger
        asChild
        className="gap-2 border-none rounded-none hover:bg-accent focus:ring-0"
      >
      ...
      <PopoverContent sideOffset={5} align="start" className="w-48 p-1">
        {items.map((item, index) => (
          <EditorBubbleItem
            ...
            className="flex items-center justify-between px-2 py-1 text-sm rounded-sm cursor-pointer hover:bg-accent"
          >
